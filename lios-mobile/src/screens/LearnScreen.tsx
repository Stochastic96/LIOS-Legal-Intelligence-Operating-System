      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        {result ? (
          ...
          <View style={styles.resultCard}>
            ...
            <Pressable style={styles.nextBtn} onPress={() => loadNext(false)}>
          ...
          <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined}>
            ...
            <View style={styles.actionRow}>
              <Pressable style={styles.skipBtn} onPress={() => loadNext(true)}>
...
const styles = StyleSheet.create({
  ...
  streakBadge: { backgroundColor: "#431407", borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4 },
  ...
  resultLine: { fontSize: 15, color: "#e2e8f0", marginBottom: 12 },
  nextTopicRow: { backgroundColor: "#166534", borderRadius: 10, padding: 10, marginBottom: 16 },
  nextTopicLabel: { fontSize: 10, fontWeight: "700", color: "#4ade80", letterSpacing: 1, textTransform: "uppercase", marginBottom: 2 },
  resultNext: { fontSize: 14, color: "#bbf7d0", fontWeight: "600" },
